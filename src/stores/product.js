...
export const useProductStore = defineStore('product', () => {
  ...
  const image_base_url = 'https://floou.hafidzirham.com/storage/';
  ...
  return { plants, plant, categories, plantTypes, isLoading, error, fetchPlants, fetchPlant, fetchCategories, fetchPlantTypes, createPlant, updatePlant, deletePlant, image_base_url };
});